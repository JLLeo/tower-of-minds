...
各 Faction 在同一层**必须对等**：一样多的人、一样厚的血、一样重的手。不对等的话「杀谁放谁」就不再是表态而是算术——人少血薄的那一方永远是更便宜的猎物，于是每一局都往同一个方向站队，而 Loadout 只能取自单个 Faction，带另一派的牌进塔就等于白交一份难度税。区分派系的是**怎么**打，不是打得动打不动。
